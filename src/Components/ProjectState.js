...
function App(props) {
  ...
  function importImage(id) {
    switch (id) {
      // UX
      case 'snap': return require('../Images/portfolio/ux/snap.png');
      case 'meet': return require('../Images/portfolio/ux/meet.png');
      case 'eatery': return require('../Images/portfolio/ux/eatery.png');
      ...
      case 'weather': return require('../Images/portfolio/cs/umbrella-img.jpg');
  ...
  // RENDERING
  return (
    <div className="container" style={containerStyle} onMouseEnter={handleHoverStart} onMouseLeave={handleHoverEnd}>
      <div style={containerStyle}>
        ...
        <div style={msgStyle}>
          <div style={projectDescription} >{props.msg}</div>
        </div>

        <a href={props.url} class="text-link"><img src={importImage(props.id)} alt="Logo" width={props.width} class="img-responsive" alt="" align="center" style={image} /></a>
