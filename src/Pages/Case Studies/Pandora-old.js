  ...
  return (
    <FadeIn transitionDuration="500">
      <div style={contentStyle}>
        ...
        {/* <div style={{ display: "inline-block", paddingTop: SECTION_SPACING }}><Gallery2 cols={[3,3,1]} totalWidth={800} data={props.chooseMoreData(uxData, ID)} title="check out a case study!" square="false" isLarge="false"></Gallery2></div> */}
